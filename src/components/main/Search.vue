  ...
  <div class="search-container">
    <div class="search-wrapper">
      ...
      <div class="category-wrapper">
        ...
        <div class="category">
          <SearchItem
            v-for="(selectValue, idx) in categories1"
            :key="idx"
            :selectValue="selectValue"
            @categorySearchShow="categorySearchShow"
          />
        </div>
        <div class="category">
          <SearchItem
            v-for="(selectValue, idx) in categories2"
            :key="idx"
            :selectValue="selectValue"
            @categorySearchShow="categorySearchShow"
          />
      ...
      <div class="record-wrapper">
        <div class="popularity-wrapper">
          ...
          <div class="popularity nf">
            <SearchItem
              v-for="(selectValue, idx) in popularityContents"
              :key="idx"
              :selectValue="selectValue"
              @categorySearchShow="categorySearchShow"
            />
