               ...
               <v-card id="report-modal" class="pwd-modal">
                  ...
                  <v-card-text>
                     <v-container>
                        ...
                        <v-row>
                           <v-select :items="subjects" label="카테고리" required v-model="editCategory"></v-select>
                        </v-row>
                     </v-container>
                  </v-card-text>
                  <v-card-actions>
...
import { findBoardsById, deleteById, updateLikes, cancelLikes, modifyBoard } from '@/api/community.js';
import { findBoardCommentsByBoardId, createBoardComment, removeBoardComment } from '@/api/communityComment.js';
